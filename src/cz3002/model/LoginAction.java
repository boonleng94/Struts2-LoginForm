...
import cz3002.repo.UserRepo;;

//Model class to hold the Action for the User
...
public class LoginAction extends ActionSupport {
	...
	public String execute() throws Exception {		
		...
		String[] params = new String[] {getUsername(), getPassword()};
		boolean isSuccess = repo.loginValidate(params);
